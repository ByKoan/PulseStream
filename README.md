...
>`Project version: 2.0.0`  (This value will be updated on every funcionality change in the project)

> ***About this version: In the last version, I added funcionality to make playlists with the music in the local disk. Features/Bugs to add/fix: Need to fix when you find a song reproduce the first of the list, need to add funcionality for adding songs to the playlist., and a funcionality to remove songs from a playlist***
